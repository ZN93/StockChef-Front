                        ...
                        <div>
                            ...
                            {!isEditingProfile ? (
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                                    ...
                                    {profile.lastLoginAt && (
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700">Dernière
                                                connexion</label>
                                            <p className="mt-1 text-gray-900">
                        ...
                        <div className="border-t pt-8">
                            ...
                            {isChangingPassword && (
                                <form onSubmit={handlePasswordSubmit} className="space-y-4 w-full sm:max-w-md">
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700">Nouveau mot de
                                            passe</label>
                                        <input
                                            type="password"
                                    ...
                                    <div>
                                        <label className="block text-sm font-medium text-gray-700">Confirmer le nouveau
                                            mot de passe</label>
                                        <input
                                            type="password"
